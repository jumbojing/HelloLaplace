...
class HelloLaplaceWidget(ScriptedLoadableModuleWidget):
  ...
  def setup(self):
    ...
    # Apply Button
    #
    self.applyButton = qt.QPushButton("Apply laplacian")
  ...
  def onApplyButton(self):
    ...
    if not (inputVolume and outputVolume):
      qt.QMessageBox.critical(slicer.util.mainWindow(), 'Laplace', 'Input and output volumes are required for Laplacian')
      return
